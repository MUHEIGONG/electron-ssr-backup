...
# 收集已知问题和解决方案[issue.md](https://github.com/MUHEIGONG/electron-ssr-backup/blob/master/issue.md)
...
下载地址见[Github release](https://github.com/MUHEIGONG/electron-ssr-backup/releases)，对应的操作系统下载的文件为
